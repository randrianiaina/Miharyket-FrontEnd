function About () {
    return(
        ...
        <title>Mihary'ket - À propos</title>
            <div className="intro-section site-blocks-cover innerpage" style={{"backgroundImage": "url('/src/images/hero_1.jpg')"}}>
            ...
            <div class="site-section services-1-wrap" data-aos="fade-up">
              <div class="container">
                <div class="row mb-5 justify-content-center text-center">
                  <div class="col-lg-7">
                    <h3 class="section-subtitle">Services</h3>
                    <h2 class="section-title mb-4 text-black">Les avantages de la plateforme Mihary'Ket</h2>
                  </div>
                </div>
                <div class="row no-gutters">
                  <div class="col-lg-4 col-md-6">
                    <div class="service-1">
                      ...
                      <div class="service-1-icon">
                        <img src="/src/images/icon-8.png" alt="Image" class="img-fluid"/>
                      </div>
                      <div class="service-1-content">
                        <h3 class="service-heading bottom">Digitalisation des coopératives</h3>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="service-1">
                      ...
                      <div class="service-1-icon">
                        <img src="/src/images/icon-3.png" alt="Image" class="img-fluid"/>
                      </div>
                      <div class="service-1-content">
                        <h3 class="service-heading">Mutualisation des matériels agricoles</h3>
                  ...
                  <div class="col-lg-4 col-md-6">
                    <div class="service-1">
                      ...
                      <div class="service-1-icon">
                        <img src="/src/images/icon-6.png" alt="Image" class="img-fluid"/>
                      </div>
                      <div class="service-1-content">
            ...
            <div class="site-section" data-aos="fade-up">
                ...
                <div class="row justify-content-center">
                    ...
                    <h3 class="section-subtitle">LES CONCEPTEURS ET DEVELOPPEURS</h3>
                    <h2 class="section-title text-black mb-4">Rencontrez l'équipe</h2>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="person">
                        <figure>
                        <img src="/src/images/herizo.jpg" width="800" heigth="800" alt="Image" class="img-fluid"/>
                        <div class="social">
                            <a href="https://www.linkedin.com/in/herizo-randrianiaina/" target="_blank"><span class="icon-linkedin"></span></a>
                        </div>
                        </figure>
                    ...
                    <div class="person">
                        <figure>
                        <img src="/src/images/mahefa.jpg" width="800" heigth="800" alt="Image" class="img-fluid"/>
                        <div class="social">
                            <a href="https://www.linkedin.com/in/mahefa-iarantsoa-47749725a/" target="_blank"><span class="icon-linkedin"></span></a>
                        </div>
                        </figure>
                        <div class="person-contents">
                    ...
                    <div class="person">
                        <figure>
                        <img src="/src/images/ninie.jpg" width="800" heigth="800" alt="Image" class="img-fluid"/>
                        <div class="social">
                            <a href="https://www.linkedin.com/in/vonintsoa-ramamonjison-baba82147/" target="_blank"><span class="icon-linkedin"></span></a>
                        </div>
                        </figure>
                        <div class="person-contents">
                    ...
                    <div class="person">
                        <figure>
                        <img src="/src/images/heritiana.png" width="800" heigth="800" alt="Image" class="img-fluid"/>
                        <div class="social">
                            <a href="https://www.linkedin.com/in/heritiana-raveloson-564347236/" target="_blank"><span class="icon-linkedin"></span></a>
                        </div>
                        </figure>
                        <div class="person-contents">
                    ...
                    <div class="person">
                        <figure>
                        <img src="/src/images/percky.jpg" width="800" heigth="800" alt="Image" class="img-fluid"/>
                        <div class="social">
                            <a href="https://www.linkedin.com/in/percky-ramanoara-138909234/" target="_blank"><span class="icon-linkedin"></span></a>
                        </div>
                        </figure>
                        <div class="person-contents">
